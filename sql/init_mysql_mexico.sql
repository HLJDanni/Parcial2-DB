...
CREATE DATABASE IF NOT EXISTS sucursal_mexico;
...
INSERT INTO clientes VALUES (1, 'Juan Pérez', 'CDMX, México', '5566-7788', 'juanp@gmail.com');
INSERT INTO clientes VALUES (2, 'María López', 'CDMX, México', '5566-7788', 'maria.lopez@hotmail.com');

INSERT INTO procuradores VALUES (1, 'Lic. Gómez', 'P001MX', '4444-5566', 'gomez@procuradores.com');
INSERT INTO procuradores VALUES (2, 'Lic. Rodríguez', 'P002MX', '6677-8899', 'rodriguez@procuradores.com');

INSERT INTO abogados VALUES (1, 'Dr. Salazar', 'A001GT', 'México', 'salazar@abogados.com');
INSERT INTO abogados VALUES (2, 'Dra. Morales', 'A002SV', 'México', 'morales@abogados.com');
